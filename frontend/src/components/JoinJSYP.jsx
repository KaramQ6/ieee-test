    ...
    <div className="bg-gradient-to-br from-[#0a001f] via-[#15002e] to-[#1a0033] text-white">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-wrap flex-col sm:flex-row gap-6 justify-center">
            <button
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105"
            >
              Official Website
            </a>
          </div>
